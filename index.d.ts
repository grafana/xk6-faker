 ...
 * 
 */
export declare interface Br {
  /**
   * Name of a random Brazilian city, either from a real city list or dynamically generated.
   * @returns a random br city
   * @example
   * ```ts
   *import { Faker } from "k6/x/faker"
   *
  ...
  /**
   * Brazilian company taxpayer registry identification number (CNPJ) with valid check digits.
   * @param formatted - Formatted
   * @param alphanumeric - Alphanumeric
   * @returns a random br cnpj
   * @example
   * ```ts
   *import { Faker } from "k6/x/faker"
   *
   ...
   *
   *export default function () {
   *  console.log(faker.br.brCnpj(true,false))
   *}
   *
   *```
   * **Output** (formatted as JSON value)
   ...
   * ```
   */
  brCnpj(formatted: boolean, alphanumeric: boolean): string;

  /**
   * Brazilian individual taxpayer registry identification number (CPF) with valid check digits.
   * @param formatted - Formatted
   * @returns a random br cpf
   * @example
   * ```ts
   *import { Faker } from "k6/x/faker"
   *
   ...
   *
   *export default function () {
   *  console.log(faker.br.brCpf(true))
   *}
   *
   *```
   * **Output** (formatted as JSON value)
   ...
   * ```
   */
  brCpf(formatted: boolean): string;

  /**
   * Brazilian fake phone number with area code (DDD) in mobile or landline format.
   * @param mobile - Mobile
   * @returns a random br phone number
   * @example
   * ```ts
   *import { Faker } from "k6/x/faker"
   *
   ...
   *
   *export default function () {
   *  console.log(faker.br.brPhoneNumber(true))
   *}
   *
   *```
   * **Output** (formatted as JSON value)
   ...
   * ```
   */
  brPhoneNumber(mobile: boolean): string;

  /**
   * Brazilian general registration number (RG) as a 9-digit numeric string.
   * @returns a random br rg
   * @example
   * ```ts
   *import { Faker } from "k6/x/faker"
   *
  ...
  /**
   * Random Brazilian e-commerce search query term (marketplace/products).
   * @param mode - Mode
   * @returns a random br search term
   * @example
   * ```ts
   *import { Faker } from "k6/x/faker"
   *
   ...
   *
   *export default function () {
   *  console.log(faker.br.brSearchTerm("random"))
   *}
   *
   *```
   * **Output** (formatted as JSON value)
   ...
   * ```
   */
  brSearchTerm(mode: string): string;

  /**
   * Full name of a random Brazilian state.
   * @returns a random br state
   * @example
   * ```ts
   *import { Faker } from "k6/x/faker"
   *
  ...
  /**
   * Two-letter abbreviation of a random Brazilian state.
   * @returns a random br state abbr
   * @example
   * ```ts
   *import { Faker } from "k6/x/faker"
   *
   ...
   *
   *export default function () {
   *  console.log(faker.br.brStateAbbr())
   *}
   *
   *```
   * **Output** (formatted as JSON value)
  ...
  /**
   * Brazilian postal code (CEP) in the format XXXXX-XXX.
   * @returns a random br zip code
   * @example
   * ```ts
   *import { Faker } from "k6/x/faker"
   *
   ...
   *
   *export default function () {
   *  console.log(faker.br.brZipCode())
   *}
   *
   *```
   * **Output** (formatted as JSON value)
...
export declare interface Car {
   ...
   * **Output** (formatted as JSON value)
   *```json
   * {"Type":"Passenger car compact","Fuel":"CNG","Transmission":"Automatic","Brand":"Daewoo","Model":"Thunderbird","Year":1988}
   * ```
   */
...
export declare interface Internet {
   ...
   * **Output** (formatted as JSON value)
   *```json
   * "Mozilla/5.0 (Macintosh; U; PPC Mac OS X 10_9_1 rv:5.0) Gecko/1905-07-30 Firefox/37.0"
   * ```
   */
...
export declare interface Payment {
   ...
   * **Output** (formatted as JSON value)
   *```json
   * {"Type":"Mastercard","Number":"2713883851665706","Exp":"04/34","Cvv":"489"}
   * ```
   */
...
export declare interface Person {
   ...
   * **Output** (formatted as JSON value)
   *```json
   * {"party":["far"],"riches":["choir"],"theirs":["still"],"mine":["how"],"that":["none"],"unless":["these"],"instead":["trip"],"here":["computer"],"whichever":["keep"],"army":["congolese"]}
   * ```
   */
...
export declare interface Time {
   ...
   * **Output** (formatted as JSON value)
   *```json
   * "2026-09-14T01:46:29.1341571-03:00"
   * ```
   */
  futureTime(): string;
   ...
   * **Output** (formatted as JSON value)
   *```json
   * "2026-09-13T05:46:29.1341571-03:00"
   * ```
   */
  pastTime(): string;
...
export declare interface Zen {
   ...
   *
   *export default function () {
   *  console.log(faker.zen.brCnpj(true,false))
   *}
   *
   *```
   * **Output** (formatted as JSON value)
   ...
   *
   *export default function () {
   *  console.log(faker.zen.brCpf(true))
   *}
   *
   *```
   * **Output** (formatted as JSON value)
   ...
   *
   *export default function () {
   *  console.log(faker.zen.brPhoneNumber(true))
   *}
   *
   *```
   * **Output** (formatted as JSON value)
   ...
   *
   *export default function () {
   *  console.log(faker.zen.brSearchTerm("random"))
   *}
   *
   *```
   * **Output** (formatted as JSON value)
   ...
   *
   *export default function () {
   *  console.log(faker.zen.brStateAbbr())
   *}
   *
   *```
   * **Output** (formatted as JSON value)
   ...
   *
   *export default function () {
   *  console.log(faker.zen.brZipCode())
   *}
   *
   *```
   * **Output** (formatted as JSON value)
   ...
   * **Output** (formatted as JSON value)
   *```json
   * "2026-09-14T01:46:29.140808-03:00"
   * ```
   */
  futureTime(): string;
   ...
   * **Output** (formatted as JSON value)
   *```json
   * "2026-09-13T05:46:29.1450719-03:00"
   * ```
   */
  pastTime(): string;
   ...
   * **Output** (formatted as JSON value)
   *```json
   * {"unless":["these"],"party":["far"],"here":["computer"],"army":["congolese"],"riches":["choir"],"theirs":["still"],"instead":["trip"],"mine":["how"],"whichever":["keep"],"that":["none"]}
   * ```
   */
  teams(people: string[], teams: string[]): Record<string, Array<string>>;
